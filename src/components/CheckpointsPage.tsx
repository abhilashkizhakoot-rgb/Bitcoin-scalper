...
export default function CheckpointsPage({ status, config, onRefresh, onTabChange }: CheckpointsPageProps) {
  ...
  const fallbackConditions: Checkpoint[] = [
    ...
    },
    {
      ...
      met: true,
      current_value: "0/10 Trades Today",
      required: "< 10 trades/day",
    ...
    },
    {
      ...
      current_value: `Balance: $${status.account_balance_usdt.toFixed(2)} USDT | ${status.is_paper_trading ? "Paper Mode Active" : "Live Keys Active"}`,
    ...
    },
    {
      ...
      met: true,
      current_value: "Clear (0 Active Loss Streak)",
